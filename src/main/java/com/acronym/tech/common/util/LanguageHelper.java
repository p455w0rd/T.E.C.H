...
public class LanguageHelper {
    ...
    public void label(String message) {
        translateMessage("label",message);
    }

    public void block(String message) {
        translateMessage("block",message);
    }
    ...
    public void description(String message) {
        translateMessage("description",message);
    }

    public void jei(String message) {
        translateMessage("jei",message);
    }
