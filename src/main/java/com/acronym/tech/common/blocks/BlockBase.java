package com.acronym.tech.common.blocks;

import com.acronym.base.util.*;
import com.acronym.tech.ModInfo;
import com.acronym.tech.common.tileentity.TileEntityBase;
...
public abstract class BlockBase extends Block implements IBlockRenderer {
    ...
    public String getUnlocalizedName() {
        ...
        return String.format("tile.%s.%s", ModInfo.MODID, blockName);
    }
        ...
        if (rotatable != null && rotatable.canBeRotated()) {
            if (this.hasCustomRotation()) {
                ...
                for (int rs = 0; rs < 4; rs++) {
                    forward = Platform.rotateAround(forward);
